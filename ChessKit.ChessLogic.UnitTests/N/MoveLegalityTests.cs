...
namespace ChessKit.ChessLogic.UnitTests.N
{
    public sealed class MoveLegalityTests
    {
        ...
        public sealed class Generic_errors_
        {
            [Fact]
            ...
            [Fact]
            public void Move_to_check_that_gives_check()
                => check("K1k5/8/8/8/8/8/8/8 b - - 1 1",
                    "c8-b8", "King, MoveToCheck");

            [Fact]
            public void Cannot_move_from_empty_cell()
                => check("rnbqk1nr/pppp1ppp/3bp3/8/4P3/7P/PPPP1PP1/RNBQKBNR w KQkq - 1 3",
                    "e2-e3", "EmptyCell");

            [Fact]
            public void Move_to_occupied_cell()
                => check("rnbqk1nr/pppp1ppp/3bp3/8/4P3/7P/PPPP1PP1/RNBQKBNR w KQkq - 1 3",
                    "a1-a2", "Rook, ToOccupiedCell");

            [Fact]
            public void Move_where_from_and_to_is_the_same_square_means_ToOccupiedCell()
                => check("rnbqk1nr/pppp1ppp/3bp3/8/4P3/7P/PPPP1PP1/RNBQKBNR w KQkq - 1 3",
                    "a1-a1", "Rook, ToOccupiedCell");

            [Fact]
            public void Wrong_side_to_move()
                => check("rnbqk1nr/pppp1ppp/3bp3/8/4P3/7P/PPPP1PP1/RNBQKBNR b KQkq - 1 3",
                    "e4-e5", "Pawn, WrongSideToMove");

            [Fact]
            public void Promotion_hint_is_not_needed()
                => check("rnbqk1nr/pppp1ppp/3bp3/8/4P3/7P/PPPP1PP1/RNBQKBNR w KQkq - 1 3",
                    "e4-e5=Q", "Pawn, PromotionHintIsNotNeeded");
        }

        public sealed class Moves_along_the_pin_line_
        {
            [Fact]
        ...
        public sealed class White_pawn
        {
            ...
            [Fact]
            public void captures_across_the_board_edge()
                => check("r1bk4/2q3n1/p1p1rp2/2p2p1p/p3QPnP/2K3P1/P1P3R1/B3N1R1 w - - 1 38",
                    "h4-a6", "Pawn, Capture, DoesNotMoveThisWay");

            [Fact]
            public void does_not_move_this_way()
                => check("rnbqk1nr/pppp1ppp/3bp3/8/4P3/7P/PPPP1PP1/RNBQKBNR w KQkq - 1 3",
                    "a2-e2", "Pawn, DoesNotMoveThisWay");

            [Fact]
            public void does_not_move_backwards()
        ...
        {
            [Fact]
            public void moves_N() => check("8/5k2/R6K/8/8/8/8/8 w - - 7 143", "h6-h7", "King");

            [Fact]
            public void moves_NW()
                => check("1r1nkb1N/p3n3/q2p3p/7P/Pp2p1p1/RPPp1Pp1/1B2PK2/5R2 w - - 0 33",
                    "f2-e3", "King");

            [Fact]
            public void captures_NS()
                => check("1r1nkb1N/p3n3/q2p3p/7P/Pp2p1p1/RPPp1Pp1/1B2PK2/5R2 w - - 0 33",
                    "f2-g3", "King, Capture");
            ...
            [Fact]
            public void moves_SW()
                => check("7b/P6r/1R6/7k/8/8/6KB/8 w - - 0 108", "g2-f1", "King");

            [Fact]
            public void moves_SE()
                => check("7b/P4r2/1R6/7k/8/8/6KB/8 w - - 5 108", "g2-h1", "King");

            [Fact]
            public void moves_W() => check("1k1K4/8/8/8/8/8/8/B7 b - - 3 100", "b8-a8", "King");

            [Fact]
            public void moves_E() => check("1K1k4/8/8/8/8/8/8/B7 b - - 3 100", "d8-e8", "King");

            [Fact]
            public void captures_the_piece_that_gives_it_check()
                => check("8/1k6/4R3/1NP4p/p2Q3P/4K1n1/3q4/8 w - - 5 73", "e3-d2",
                    "King, Capture");

            [Fact]
            public void doesnt_move_a6_h5()
                => check("8/5K2/k7/8/3N4/1P4Q1/8/8 b - - 6 110", "a6-h5",
                    "King, DoesNotMoveThisWay");

            [Fact]
            public void doesnt_move_h1_a2()
        ...
        {
            [Fact]
            public void moves_one_square_SW()
        ...
        public sealed class Queen
        {
            ...
            [Fact]
            public void moves_one_square_S()
                => check(
            ...
            [Fact]
            public void captures_one_square_E()
                => check(
                    "4k2r/2r1np1p/1p5b/p2p2p1/qPb2PP1/P1P1P2P/1B1P1KN1/R5R1 b k - 2 25",
                    "a4-b4", "Queen, Capture");

            [Fact]
            public void does_not_jump_over_adjacent_pieces()
                => check("rnbqkbnr/pp1ppp1p/6p1/2p5/7P/2N5/PPPPPPP1/R1BQKBNR w KQkq c6 0 3",
                    "d1-b1", "Queen, DoesNotJump");

            [Fact]
            public void does_not_jump_over_remote_opponent_piece()
        ...
        {
            [Fact]
            public void X101() => check(
                "rnbqkb1r/p2ppp1p/6pn/1pp5/4N2P/7N/PPPPPPP1/R1BQKBR1 b Qkq - 3 5",
                "c8-b7", "Bishop");

            [Fact]
            public void X102() => check(
                "rnbqkbnr/1pppppp1/p7/7p/8/3P1N2/PPP1PPPP/RNBQKB1R w KQkq - 0 3",
                "d1-g4", "Queen, DoesNotJump");

            [Fact]
            public void X103() => check(
                "rnbqkbnr/1pp1pppp/8/p2p4/3PP3/8/PPP2PPP/RNBQKBNR w KQkq d6 0 3",
                "c1-a3", "Bishop, DoesNotJump");

            [Fact]
            public void X104() => check(
                "rnb1k3/2q1r1np/p1pp1p2/p1b1Pp2/1P2P3/4QNP1/P1PK1PRP/R1B5 w q - 3 23",
                "d2-b2", "King, DoesNotMoveThisWay");

            [Fact]
            public void X105() => check("2b1k2r/r2p1ppp/2p1p3/p7/4P1nq/1P3PP1/P3K2P/3RbBNR w k - 7 23",
                "e2-g2", "King, DoesNotMoveThisWay");

            [Fact]
            public void X106() => check(
                "r1bqkbnr/pppp1ppp/n7/4p3/5P2/3P4/PPP1P1PP/RNBQKBNR w KQkq - 1 3",
                "e1-a3", "King, DoesNotMoveThisWay");

            [Fact]
            public void X107() => check(
                "rnbqkbnr/p3ppp1/2p5/1p1p3p/3P4/2P5/PPQ1PPPP/RNB1KBNR b KQkq - 1 5",
                "b5-b3", "Pawn, DoesNotMoveThisWay");

            [Fact]
            public void X108() => check(
                "rnbqkb1r/ppp2ppp/8/3pp1N1/1P3PnP/2P5/P2PP1P1/RNBQKBR1 w Qkq - 1 1",
                "e1-f2", "King, MoveToCheck");

            [Fact]
            public void X109() => check("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
                "b1-a3", "Knight");

            [Fact]
            public void X110() => check(
                "1n2kb1r/q3p1p1/3p1Bpp/p1pN4/1p2P3/2PP1N1b/PP3P1P/R3K2R w Kk - 2 23",
                "e1-g1", "King, WK, CastlingThroughCheck");

            [Fact]
            public void X111() => check("1n3kn1/rpPb1p2/1P6/p1p3p1/P1B1PP2/2P4r/R5p1/1N2K2R w K - 1 28",
                "e1-g1", "King, WK, CastlingThroughCheck");

            [Fact]
            public void X112() => check("r3kbn1/p2nBNp1/r7/1b1P4/RP1P1P1P/3q2p1/3N2BR/4K3 b q - 1 30",
                "e8-c8", "King, BQ, CastlingThroughCheck");

            [Fact]
            public void X113() => check(
                "rnbqkbnr/ppp2p1p/3p4/4pPp1/4P3/8/PPPP2PP/RNBQKBNR w KQkq g3 0 4",
                "f5-g6", "Pawn, Capture, EnPassant");

            [Fact]
            public void X114() => check(
                "2r1kn1r/5p1p/1pq4b/p2p2p1/1P2PPP1/P1P1K2P/1B4N1/2R2bR1 w - - 7 33",
                "c1-c4", "Rook, DoesNotJump");

            [Fact]
            public void X115() => check("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
                "a2-a4", "Pawn, DoublePush");

            [Fact]
            public void X116() => check(
                "rnbqkbnr/ppppp1p1/5p2/7p/2P5/N4P2/PP1PP1PP/R1BQKBNR b KQkq c3 0 3",
                "b7-c6", "Pawn, OnlyCapturesThisWay");

            [Fact]
            public void X117() => check(
                "2b1qb1r/1pppkppp/r7/p2np1N1/2B1P1P1/4K3/PPPPQP1P/RNB2R2 w - - 1 11",
                "e4-d5", "Pawn, Capture");

            [Fact]
            public void X118() => check("7r/B2b2pp/3qpbk1/pN2n3/1Pp1NP1P/7K/P5P1/R1Q2BR1 b - b3 0 32",
                "c4-b3", "Pawn, Capture, EnPassant");

            [Fact]
            public void X119() => check("r2k4/p1p1np2/1p2b1p1/n3p2r/2P2P1P/b6N/RB2P1KR/1NQ5 w - - 2 21",
                "b2-a1", "Bishop");

            [Fact]
            public void X120() => check("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
                "c1-e3", "Bishop, DoesNotJump");

            [Fact]
            public void X121() => check("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
                "d1-a3", "Queen, DoesNotMoveThisWay");

            [Fact]
            public void X122() => check("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
                "d1-b3", "Queen, DoesNotJump");

            [Fact]
            public void X123() => check("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
                "d1-b3", "Queen, DoesNotJump");

            [Fact]
            public void X124() => check("rnbqkbnr/pppppppp/8/8/7P/8/PPPPPPP1/RNBQKBNR b KQkq h3 0 1",
                "b8-a6", "Knight");

            [Fact]
            public void X125() => check("rnbqkbnr/pppppppp/8/8/7P/8/PPPPPPP1/RNBQKBNR b KQkq h3 0 1",
                "c8-h3", "Bishop, DoesNotJump");

            [Fact]
            public void X126() => check("rnbqkbnr/pppppppp/8/8/7P/8/PPPPPPP1/RNBQKBNR b KQkq h3 0 1",
                "c8-a6", "Bishop, DoesNotJump");

            [Fact]
            public void X127() => check(
                "rnbqkbnr/pppppp2/8/6pp/2P1P2P/8/PP1P1PP1/RNBQKBNR b KQkq c3 0 3",
                "f8-h6", "Bishop");

            [Fact]
            public void X128() => check(
                "rnbqkbnr/pp1ppp2/2p5/6pp/2P1P2P/8/PP1P1PP1/RNBQKBNR w KQkq - 0 4",
                "d1-c2", "Queen");

            [Fact]
            public void X129() => check(
                "rnbqkbnr/pp1p1p2/2p5/4p1pp/2P1P2P/3B4/PP1P1PP1/RNBQK1NR w KQkq e6 0 5",
                "e1-f1", "King");

            [Fact]
            public void X130() => check(
                "rnbqkbn1/pp1p1p1r/2p5/4p1pp/2P1P2P/3B4/PPQP1PP1/RNB1K1NR w KQq - 2 6",
                "e1-d1", "King");

            [Fact]
            public void X131() => check(
                "rnbqkbn1/pp1p1p1r/2p5/4p1pp/2P1P2P/3B4/PPQP1PP1/RNB1K1NR w KQq - 2 6",
                "c2-d1", "Queen");

            [Fact]
            public void X132() => check(
                "rnbqkbn1/pp1p1p1r/2p5/4p1pp/2P1P2P/3B4/PPQP1PP1/RNB1K1NR w KQq - 2 6",
                "c2-c3", "Queen");

            [Fact]
            public void X133() => check(
                "rnbqkbn1/pp1p1p1r/2p5/4p1pp/2P1P2P/3B4/PPQP1PP1/RNB1K1NR w KQq - 2 6",
                "c2-c5", "Queen, DoesNotJump");

            [Fact]
            public void X134() => check(
                "rnbqkbn1/pp1p1p1r/2p5/4p1pp/2P1P2P/3B4/PPQP1PP1/RNB1K1NR w KQq - 2 6",
                "c2-c5", "Queen, DoesNotJump");

            [Fact]
            public void X135() => check(
                "rnbqkbn1/pp3p1r/2p5/3pp1pp/Q1P1P2P/3B4/PP1P1PP1/RNB1K1NR w KQq d6 0 7",
                "a4-a3", "Queen");

            [Fact]
            public void X136() => check(
                "rnbqkbn1/pp3p1r/2p5/3pp1pp/Q1P1P2P/3B4/PP1P1PP1/RNB1K1NR w KQq d6 0 7",
                "a4-a3", "Queen");

            [Fact]
            public void X137() => check(
                "rnbqkbn1/pp3p1r/2p5/3pp1pp/Q1P1P2P/3B4/PP1P1PP1/RNB1K1NR w KQq d6 0 7",
                "a4-d4", "Queen, DoesNotJump");

            [Fact]
            public void X138() => check(
                "rnbqkbn1/pp3p1r/2p5/3pp1pp/Q1P1P2P/8/PP1PBPP1/RNB1K1NR b KQq - 1 7",
                "b8-d7", "Knight");

            [Fact]
            public void X139() => check(
                "rn2kbn1/pp3p1r/2p1b3/3Pp1Pp/1QP5/8/PP1PBPPR/RNB2KN1 w q - 1 13",
                "b4-e1", "Queen, DoesNotJump");

            [Fact]
            public void X140() => check(
                "rn2kbn1/pp3p1r/2p1b3/3Pp1Pp/1QP5/8/PP1PBPPR/RNB2KN1 w q - 1 13",
                "b4-a3", "Queen");

            [Fact]
            public void X141() => check(
                "rn2kbn1/pp3p1r/2p1b3/3Pp1Pp/Q1P5/8/PP1PBPPR/RNB2KN1 b q - 2 13",
                "e6-d7", "Bishop");

            [Fact]
            public void X142() => check(
                "rn2kb2/pp3p1r/2p1bn2/3Pp1PR/Q1P5/8/PP1PBPP1/RNB2KN1 b q - 0 14",
                "e6-g8", "Bishop, DoesNotJump");

            [Fact]
            public void X143() => check(
                "rn2kb2/pp3p1r/2p1bn2/3Pp1PR/Q1P5/8/PP1PBPP1/RNB2KN1 b q - 0 14",
                "f6-d7", "Knight");

            [Fact]
            public void X144() => check(
                "rn2k3/pp3p1r/2pbbn2/3Pp1PR/Q1P5/8/PP1P1PP1/RNBB1KN1 b q - 2 15",
                "d6-e7", "Bishop");

            [Fact]
            public void X145() => check(
                "rn1k1bn1/pp1b4/2p2p2/3PpBr1/QPPB3R/3P1N2/P4PP1/RN3K2 w - - 0 26",
                "d4-g1", "Bishop, DoesNotJump");

            [Fact]
            public void X146() => check(
                "r2k1bn1/pp1n3B/2p2p2/3Ppb2/QPP4R/3P1N2/P2N1Pr1/R3BK2 b - - 5 29",
                "f5-c8", "Bishop, DoesNotJump");

            [Fact]
            public void X147() => check(
                "r2k1bn1/pp1n3B/2p2pb1/3Pp3/QPP4R/3P1N2/P2N1Pr1/R3BK2 w - - 6 30",
                "a1-c1", "Rook");

            [Fact]
            public void X148() => check(
                "r4bn1/ppkn3B/2p2pb1/3Pp3/QPP4R/3P1N2/P2N1Pr1/1R2BK2 w - - 8 31",
                "a4-a1", "Queen, DoesNotJump");

            [Fact]
            public void X149() => check(
                "r4bn1/p1kn3B/2p2pb1/1p1P4/QPP1p3/3P1N2/P2N1PKR/1R2B3 w - - 0 33",
                "g2-g1", "King");

            [Fact]
            public void X150() => check("r4bn1/p1k5/2p2pB1/1p1Pn3/QPP1p3/3P1N2/P2N1PKR/3RB3 b - - 0 34",
                "e5-g6", "Knight, Capture");

            [Fact]
            public void X151() => check("r4bn1/p1k5/2p2pB1/1p1Pn3/QPP1p3/3P1N2/P2N1PKR/3RB3 b - - 0 34",
                "e5-d7", "Knight");

            [Fact]
            public void X152() => check("7Q/8/1k2B3/p7/3R2p1/8/4b3/6K1 w - - 11 88", "h8-a1",
                "Queen, DoesNotJump");

            [Fact]
            public void X153() => check(
                "rnbqkbr1/2pppppp/pp6/4B3/PPP3n1/1Q6/3PPPPP/RN2KBNR w KQq - 4 8",
                "b3-c3", "Queen");

            [Fact]
            public void X154() => check(
                "r1bq4/n1Bkb1r1/1p6/pP1PP2p/P4pn1/5N1P/3PP1PR/RN1K1B2 w - - 0 21",
                "h2-h1", "Rook");

            [Fact]
            public void X155() => check("r2qk3/n7/3P2r1/pPB4p/N1R2pn1/5P1P/2bP3R/4K2B w - - 6 34",
                "c4-c1", "Rook, DoesNotJump");

            [Fact]
            public void X156() => check(
                "r1bqkbr1/2B1ppp1/ppn5/3p3p/PPP2Pn1/8/Q2PP1PP/RN2KBNR w KQq d6 0 11",
                "c7-a5", "Bishop, DoesNotJump");

            [Fact]
            public void X157() => check(
                "r1bq1b2/n1Bk2r1/pp3p2/1P1pP2p/P1P3n1/5N2/3PP1PP/RN2KB1R w KQ - 2 17",
                "f3-g1", "Knight");

            [Fact]
            public void X158() => check(
                "r1bq4/n1Bkb1r1/1p6/pP1PPp1p/P5n1/5N1P/3PP1P1/RN1K1B1R w - - 2 20",
                "f3-e1", "Knight");

            [Fact]
            public void X159() => check(
                "rnbqkb1r/1ppppppp/p7/5n2/1PP5/B7/P2PPPPP/RN1QKBNR w KQkq - 3 4",
                "h1-c1", "Rook, DoesNotJump");

            [Fact]
            public void X160() => check("r2q4/nb1k4/1B1P4/pP1P2rp/N4pn1/5P1P/3P2BR/R3K3 b - - 2 29",
                "g5-g7", "Rook");

            [Fact]
            public void X161() => check("rnbqkbnr/pppppppp/8/8/2P5/8/PP1PPPPP/RNBQKBNR b KQkq c3 0 1",
                "a8-a1", "Rook, Capture, DoesNotJump");

            [Fact]
            public void X162() => check("rnbqkbnr/1ppppppp/p7/8/1PP5/8/P2PPPPP/RNBQKBNR b KQkq b3 0 2",
                "a8-a7", "Rook");

            [Fact]
            public void X163() => check("rnbqkb1r/1ppppppp/p6n/8/1PP5/B7/P2PPPPP/RN1QKBNR b KQkq - 2 3",
                "h8-g8", "Rook");

            [Fact]
            public void X164() => check(
                "r1bqkbr1/2pppppp/ppn5/4B3/PPP2Pn1/8/Q2PP1PP/RN2KBNR b KQq f3 0 9",
                "g8-b8", "Rook, DoesNotJump");

            [Fact]
            public void X165() => check("1r3k2/n3q3/1P1r4/p3B2p/NR3pP1/5P2/2bP3R/4K2B b - - 5 38",
                "e7-e8", "Queen");

            [Fact]
            public void X166() => check("8/r7/1P1k2b1/pB3R2/3P1qpR/8/2n5/6K1 b - - 7 56", "f4-f6",
                "Queen, DoesNotJump");

            [Fact]
            public void X167() => check("rnbqkb1r/1ppppppp/p6n/8/1PP5/B7/P2PPPPP/RN1QKBNR b KQkq - 2 3",
                "d8-g8", "Queen, DoesNotJump");

            [Fact]
            public void X168() => check("rnbqkbnr/pppppppp/8/8/2P5/8/PP1PPPPP/RNBQKBNR b KQkq c3 0 1",
                "d8-d1", "Queen, Capture, DoesNotJump");

            [Fact]
            public void X169() => check("1r3k2/3r4/1P6/p1q1B2p/1R1P1pPR/n4P2/2b3B1/4K3 b - - 1 42",
                "c5-d6", "Queen");

            [Fact]
            public void X170() => check("rnbqkbnr/pppppppp/8/8/2P5/8/PP1PPPPP/RNBQKBNR b KQkq c3 0 1",
                "d8-h4", "Queen, DoesNotJump");

            [Fact]
            public void X171() => check(
                "r1bqkbr1/2B2pp1/ppn5/3pP2p/PPP3n1/8/2QPP1PP/RN2KBNR b KQq - 0 12",
                "d8-h4", "Queen");

            [Fact]
            public void X172() => check("1r3k2/n3q3/1P1r4/p3B2p/NR3pP1/5P2/2bP3R/4K2B b - - 5 38",
                "e7-d8", "Queen");

            [Fact]
            public void X173() => check("1r3k2/n3q3/1P1r4/p3B2p/NR3pP1/5P2/2bP3R/4K2B b - - 5 38",
                "e7-d8", "Queen");

            [Fact]
            public void X174() => check("1r3k2/3r4/1P6/p1q1B2p/1R1P1pPR/n4P2/2b3B1/4K3 b - - 1 42",
                "c5-a7", "Queen, DoesNotJump");

            [Fact]
            public void X175() => check(
                "r1bqkbr1/2B1ppp1/ppn5/3p3p/PPP2Pn1/8/2QPP1PP/RN2KBNR b KQq - 1 11",
                "e8-d7", "King");

            [Fact]
            public void X176() => check(
                "r1bq1br1/2Bk1pp1/ppn5/1P1pP2p/P1P3n1/8/2QPP1PP/RN2KBNR b KQ - 0 13",
                "d7-e6", "King");

            [Fact]
            public void X177() => check(
                "r1bq1br1/2Bk1pp1/ppn5/1P1pP2p/P1P3n1/8/2QPP1PP/RN2KBNR b KQ - 0 13",
                "d7-e7", "King");

            [Fact]
            public void X178() => check(
                "r1bq1br1/2Bk1pp1/ppn5/1P1pP2p/P1P3n1/8/2QPP1PP/RN2KBNR b KQ - 0 13",
                "d7-e8", "King");

            [Fact]
            public void X179() => check("r2q4/nb1kb1r1/1B6/pP1PP2p/P4pn1/5P1P/3PP2R/RN1K1B2 b - - 0 22",
                "d7-c8", "King");

            [Fact]
            public void X180() => check("rq4r1/nb1k4/1B1P4/pP1P3p/P4pn1/2N2P1P/3PP1BR/R2K4 b - - 4 25",
                "d7-d8", "King, MoveToCheck");

            [Fact]
            public void X181() => check(
                "rnbqkb1r/1ppppppp/p7/5n2/1PP5/B7/P2PPPPP/RN1QKBNR w KQkq - 3 4",
                "a1-c1", "Rook, DoesNotJump");

            [Fact]
            public void X182() => check("4k3/p1rn2br/1qpBpnpp/1P6/P7/3p1P2/1RP2P1P/4K2R b K - 0 21",
                "b6-d8", "Queen, DoesNotJump");

            [Fact]
            public void X183() => check("2b1r3/4ppb1/6r1/1pkpn3/1p5Q/1n1p3B/2N2K2/6R1 b - - 1 48",
                "g6-g8", "Rook, DoesNotJump");

            [Fact]
            public void X184() => check("2k5/8/4Q3/K7/4r3/8/8/7q b - - 1 122", "e4-e7",
                "Rook, DoesNotJump");

            [Fact]
            public void X185() => check(
                "1r4nr/p1p3kp/2bq2pb/2nNp3/pP1p1P1P/2PPBPN1/QR2K3/7R w - - 5 26",
                "a2-c1", "Queen, DoesNotMoveThisWay");

            [Fact]
            public void X186() => check(
                "1n3bn1/N1p1q3/1p3p2/3Bp1pr/r2NPP1p/pQ1PBK1k/P1R4P/6R1 b - - 5 34",
                "e7-a8", "Queen, DoesNotMoveThisWay");

            [Fact]
            public void X187() => check(
                "r3kbnr/p1pqpp2/n6p/Pp6/1Q6/2p2b1P/1P1PP1P1/RNB1KBNR w KQq - 2 13",
                "b4-d5", "Queen, DoesNotMoveThisWay");

            [Fact]
            public void X188() => check(
                "rn3r2/pbpn1p2/6q1/P2Pk3/1p1b4/3BPpP1/1B1P4/1N1Q1K1R b - - 5 34",
                "g6-a1", "Queen, DoesNotMoveThisWay");

            [Fact]
            public void X189() => check("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
                "c1-b3", "Bishop, DoesNotMoveThisWay");

            [Fact]
            public void X190() => check("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
                "h1-a3", "Rook, DoesNotMoveThisWay");

            [Fact]
            public void X191() => check("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
                "h1-a3", "Rook, DoesNotMoveThisWay");

            [Fact]
            public void X192() => check("rnbqkbnr/1ppppppp/8/p7/6P1/8/PPPPPP1P/RNBQKBNR w KQkq a6 0 2",
                "h2-g2", "Pawn, DoesNotMoveThisWay");

            [Fact]
            public void X193() => check("rnbqkb1r/pppppppp/5n2/8/4PP2/8/PPPP2PP/RNBQKBNR b KQkq e3 0 2",
                "a7-g8", "Pawn, DoesNotMoveThisWay");

            [Fact]
            public void X194() => check("rnb1kbnr/ppqppppp/8/2p5/5P2/5K2/PPPPP1PP/RNBQ1BNR b kq - 3 3",
                "c8-d8", "Bishop, DoesNotMoveThisWay");

            [Fact]
            public void X195() => check(
                "r1bqkbnr/pppp1ppp/2n5/4p3/4P3/7N/PPPP1PPP/RNBQKB1R w KQkq e6 0 3",
                "d1-e2", "Queen");

            [Fact]
            public void X196() => check("rnbqkbnr/1ppppppp/p7/8/8/2N5/PPPPPPPP/R1BQKBNR w KQkq - 0 2",
                "e1-b1", "King, DoesNotMoveThisWay");

            [Fact]
            public void X197() => check(
                "rnbqkb1r/p1ppp1pp/1p3p1n/8/1P6/N4N2/P1PPPPPP/R1BQKB1R w KQkq - 0 4",
                "c1-b2", "Bishop");

            [Fact]
            public void X198() => check(
                "rnb1kb2/pp1ppppr/2p4n/3P3p/2P1P2R/P4q1N/1P2QPP1/RN2KB2 b Qq - 6 9",
                "h7-d8", "Rook, DoesNotMoveThisWay");

            [Fact]
            public void X199() => check(
                "rn1k1b1r/pb1pp1p1/2p2p2/7p/Npq1P3/P2PP3/1PQB2PP/R2K1BNR b - - 3 13",
                "d8-g8", "King, DoesNotMoveThisWay");

            [Fact]
            public void X200() => check(
                "rnb1k2r/pppp1ppp/3bp2n/8/3P3q/PP6/1BP1PPPP/RN1QKBNR w KQkq - 3 5",
                "b2-c1", "Bishop");

            [Fact]
            public void X201() => check("2b3k1/6p1/p1r3p1/P2p2B1/n1P1p3/2R5/3p1K2/8 w - - 3 69",
                "c3-a1", "Rook, DoesNotMoveThisWay");

            [Fact]
            public void X202() => check("rnbqkbnr/pppppppp/8/8/5P2/8/PPPPP1PP/RNBQKBNR b KQkq f3 0 1",
                "d8-a1", "Queen, Capture, DoesNotMoveThisWay");

            [Fact]
            public void X203() => check("rnbqkbnr/pppppppp/8/8/2P5/8/PP1PPPPP/RNBQKBNR b KQkq c3 0 1",
                "d8-a5", "Queen, DoesNotJump");

            [Fact]
            public void X204() => check(
                "r2qkbnr/2p1pppp/p1n5/1B1p4/3PPB2/N6b/PPP2PPP/R2QK1R1 w Qkq - 0 9",
                "d1-b1", "Queen");

            [Fact]
            public void X205() => check("2r1k1nr/Qp1b4/B1p4p/2P2p2/3p1P2/7N/PBK3pP/2R2R2 w k - 2 33",
                "f1-f2", "Rook");

            [Fact]
            public void X206() => check("6R1/2Pr4/b2k1n2/3B2N1/p2n4/6pp/3R3P/4K3 w - - 1 68", "e1-c1",
                "King, WQ, HasNoCastling");

            [Fact]
            public void X207() => check("rnbqk1nr/ppppppbp/6p1/8/8/5P1P/P1PPBPPR/RNBQK3 w Qkq - 4 6",
                "e1-g1", "King, WK, HasNoCastling");

            [Fact]
            public void X208() => check("rnbqkbnr/pppppppp/8/8/8/4P3/PPPP1PPP/RNBQKBNR b KQkq - 0 1",
                "e8-a1", "King, Capture, DoesNotMoveThisWay");

            [Fact]
            public void X209() => check(
                "r1b1kbnr/ppqn1p1p/2p1p1p1/2Np4/4PB2/P2P4/1PPQ1PPP/R3KBNR w KQkq - 2 10",
                "e1-c1", "King, WQ");

            [Fact]
            public void X210() => check("8/8/8/8/8/8/8/4K1k1 w - - 18487 9430", "e1-g1",
                "King, WK, Capture, DoesNotCaptureThisWay");

            [Fact]
            public void X211() => check("8/8/8/8/8/8/8/2k1K3 w - - 12136 6266", "e1-c1",
                "King, WQ, Capture, DoesNotCaptureThisWay");

            [Fact]
            public void X212() => check(
                "rnb4r/p2p1k1p/1ppbp1p1/6Q1/1P2P1pn/P1NP1P1N/R3q1BP/2B1K2R w K - 4 16",
                "e1-g1", "King, WK, CastleFromCheck");

            [Fact]
            public void X213() => check("8/8/k7/5p1P/pP3P2/4q3/8/4K3 w - - 5 75", "e1-c1",
                "King, WQ, HasNoCastling");

            [Fact]
            public void X214() => check(
                "r1bqkb1r/pppp2pp/n3pn2/5p2/4P1Q1/3B4/PPPP1PPP/RNB1K1NR b KQkq - 3 5",
                "e8-g8", "King, BK, DoesNotJump");

            [Fact]
            public void X215() => check(
                "rnb1k2r/1p1p2p1/2pbp3/p2n1p2/3P2pP/P1P2N2/1PK1P1B1/RNB1Q2R b kq - 3 16",
                "e8-g8", "King, BK");

            [Fact]
            public void X216() => check("4k1B1/2r5/1B3pn1/3p1P2/p4b1p/7P/8/4K3 b - - 7 72", "e8-g8",
                "King, BK, Capture, DoesNotCaptureThisWay");

            [Fact]
            public void X217() => check("r1bqkbnr/pppppppp/2n5/8/8/5P2/PPPPP1PP/RNBQKBNR w KQkq - 1 2",
                "e2-f3", "Pawn, ToOccupiedCell");

            [Fact]
            public void X218() => check("r1bqkbnr/pppppppp/2n5/8/8/5P2/PPPPP1PP/RNBQKBNR w KQkq - 1 2",
                "g2-f3", "Pawn, ToOccupiedCell");

            [Fact]
            public void X219() => check("8/8/p2P4/B7/P1B2p2/4k1P1/K4p2/4R3 b - - 1 61", "f2-e1=Q",
                "Pawn, Promotion, Capture");

            [Fact]
            public void X220() => check(
                "rnbqk1nr/2pp4/4pp2/ppP3p1/7p/5PPN/PPPBP2P/RN1QKB1R w KQkq b6 0 10",
                "b7-b5", "Capture, EmptyCell");

            [Fact]
            public void X221() => check(
                "3b1rrk/pp3N2/P1pN2p1/P7/4p1b1/B2PPp1P/RQP2P1q/3B1K2 b - - 5 37",
                "f8-f7", "Rook, Capture, MoveToCheck");

            [Fact]
            public void X222() => check("8/3Prp2/p2N4/1nP2k1R/8/1p5P/7R/2K4B b - - 6 62", "b5-d6",
                "Knight, Capture, MoveToCheck");

            [Fact]
            public void X223() => check("8/8/5k1P/8/4BK2/8/8/8 b - - 4 123", "f6-g5",
                "King, MoveToCheck");

            [Fact]
            public void X224() => check("8/8/4k2P/5B2/5K2/8/8/8 b - - 6 124", "e6-f5",
                "King, Capture, MoveToCheck");

            [Fact]
            public void X225() => check("6n1/8/2k3PR/K4P2/4p3/2p5/4b3/8 b - - 9 101", "c6-b5",
                "King, MoveToCheck");

            [Fact]
            public void X226() => check("nb6/1b6/2p5/p1PP4/3K1p1Q/1P6/5k2/8 b - - 2 84", "f2-e3",
                "King, MoveToCheck");

            [Fact]
            public void X227() => check("nb6/1b4Q1/2p5/p1PP4/3K1p2/1P6/3k4/8 b - - 6 86", "d2-d3",
                "King, MoveToCheck");

            [Fact]
            public void X228() => check("8/8/2P4K/p2p4/5n2/1P3p2/8/3k1bb1 w - - 10 101", "h6-g6",
                "King, MoveToCheck");

            [Fact]
            public void X229() => check("8/6K1/b1P3n1/p7/3p4/1P3p2/8/3k2b1 w - - 4 104", "g7-f8",
                "King, MoveToCheck");

            [Fact]
            public void X230() => check(
                "8/rb1k1r1p/1p1q3n/p1pp1p2/P3pQ1P/1P1P1BPN/R1n1P3/2B2K1R w - - 0 37",
                "f1-e1", "King, MoveToCheck");

            [Fact]
            public void X231() => check("nb6/1b6/2p5/p1PP4/3K1p2/1P4Q1/3k4/8 w - - 5 86", "d4-d3",
                "King, MoveToCheck");

            [Fact]
            public void X232() => check("8/8/4k1BP/8/5K2/8/8/8 w - - 1 122", "f4-e5",
                "King, MoveToCheck");

            [Fact]
            public void X233() => check("8/8/5k1P/8/5K2/8/2B5/8 w - - 3 123", "f4-e5",
                "King, MoveToCheck");

            [Fact]
            public void X234() => check("3R4/2rn2r1/3k1Np1/p1pp2p1/p2P4/2b4p/7P/B2K4 b - - 0 0",
                "d8-e8", "Rook, WrongSideToMove");

            [Fact]
            public void X235() => check("nb6/1b3k2/2p1p2P/p1KP4/2P5/1PR5/8/8 w - - 1 77", "h6-h7",
                "Pawn");

            [Fact]
            public void X236() => check("1K6/1P6/8/8/k7/7b/pq6/8 w - - 14 150", "b8-a7", "King");

            [Fact]
            public void X237() => check("r1b1kbnr/ppp2p2/6p1/n3p2p/8/P4PP1/1PPqPK1P/RNBQ2NR w kq - 2 8",
                "d2-d3", "Queen, WrongSideToMove");

            [Fact]
            public void X238() => check("7R/4n3/2k3P1/5P2/1K2p3/2p2b2/8/8 w - - 0 97", "f3-g4",
                "Bishop, WrongSideToMove");

            [Fact]
            public void X239() => check(
                "1r1q1rnk/pb1pp3/npp4b/B2P1p2/P1PKN1P1/4PNPB/1P3P2/R3R3 w - - 7 24",
                "f5-f4", "Pawn, WrongSideToMove");

            [Fact]
            public void X240() => check("3B4/8/1K6/2R1r3/p5k1/8/5q2/8 w - - 8 139", "g2-g3",
                "EmptyCell");

            [Fact]
            public void X241() => check("3k4/4n3/1p4pr/5B2/7n/3qR1P1/2P1P2P/R4K2 w - - 15 51", "d2-d3",
                "Capture, EmptyCell");

            [Fact]
            public void X242() => check("4k3/8/8/2p5/2P4P/p5K1/2N2B2/4q3 w - - 16 134", "h1-h2",
                "EmptyCell");

            [Fact]
            public void X243() => check("Rnb2kr1/3pnq2/1p3pp1/1N4Np/4P3/8/1bPKPPPP/2BQ1BR1 b - - 0 19",
                "a1-a2", "EmptyCell");

            [Fact]
            public void X244() => check("8/2n5/2P5/p1bp4/6K1/1P3p2/4b3/3k4 b - - 1 96", "b3-b4",
                "Pawn, WrongSideToMove");

            [Fact]
            public void X245() => check(
                "rn2k1nQ/pb1p1p2/5q2/1p2p3/1b1pP3/1P3P2/P1PNB1PP/R1BK2NR b q - 0 13",
                "a1-b1", "Rook, WrongSideToMove");

            [Fact]
            public void X246() => check(
                "3r1B1r/1bppn2p/1b1k2p1/pP2p3/4P2P/2RP1P1P/2P3B1/4K1nR b - - 3 27",
                "e1-f1", "King, WrongSideToMove");

            [Fact]
            public void X247() => check("1B3q2/5p2/3n4/p3k2P/P1P4P/PK3P2/6R1/8 b - - 6 68", "g2-g3",
                "Rook, WrongSideToMove");

            [Fact]
            public void X248() => check("2Q5/5k2/8/1P3P2/3B3P/8/4R1K1/6q1 w - - 2 88", "d4-g1",
                "Bishop, Capture");

            [Fact]
            public void X249() => check("r1b1k1n1/ppp1bp2/6pr/n3p2P/1qP4P/P4P2/4P3/RNBQK1NR w q - 1 13",
                "b1-c3", "Knight");

            [Fact]
            public void X250() => check("Rnb2kr1/3pn1q1/1p1N1pp1/6Np/4P3/b7/2PKPPPP/2BQ1BR1 w - - 3 21",
                "d6-c8", "Knight, Capture");

            [Fact]
            public void X251() => check("3r4/2P5/3r3k/3n1PN1/Pp1b1n2/4p1P1/R7/1N4K1 w - - 2 65",
                "g5-h3", "Knight");

            [Fact]
            public void X252() => check(
                "r1b1kbnr/ppp2p2/2n3p1/4p2p/8/P4PP1/1PPqP2P/RNBQK1NR w KQkq - 0 7",
                "b1-d2", "Knight, Capture");

            [Fact]
            public void X253() => check("4qk2/4n1r1/1p2b1p1/3p4/7N/5nPB/1RP1P2P/4K1R1 w - - 0 38",
                "h4-f3", "Knight, Capture");

            [Fact]
            public void X254() => check("8/3k4/1q4BP/8/8/8/5K2/4R3 w - - 19 117", "e1-e3", "Rook");

            [Fact]
            public void X255() => check("3k4/8/q3R2n/1p4pB/4P2P/2P5/7P/1rR4K w - - 1 61", "c1-d1",
                "Rook");

            [Fact]
            public void X256() => check("3kr3/npp2p2/1P6/3rpbpp/p1PRP2P/2N2N2/5PQ1/3KBBR1 w - - 5 38",
                "d4-d3", "Rook");

            [Fact]
            public void X257() => check("8/3N2r1/4k3/p1p3R1/p2r4/6pp/1b1B3P/3K4 w - - 0 68", "d7-c5",
                "Knight, Capture");

            [Fact]
            public void X258() => check("1n3R2/2N3k1/p7/r2p3q/5p2/4K3/8/4N3 w - - 0 85", "f8-f4",
                "Rook, Capture");

            [Fact]
            public void X259() => check("1n6/1pk2r2/3R1pP1/1pP2b1p/3NP3/1Q5B/3K1P2/6R1 w - - 1 62",
                "d6-c6", "Rook");

            [Fact]
            public void X260() => check(
                "r2q3r/1bpkp2p/np1p3n/p4p2/P4p2/N1Q3PP/1P1PP1K1/R1B2BNR w - - 1 18",
                "c3-f3", "Queen");

            [Fact]
            public void X261() => check(
                "rn3b1r/p2pk2p/b3p1pn/1pp5/1P2Pp1P/2PP3R/PB2K1P1/RN1QqBN1 w - - 2 16",
                "d1-e1", "Queen, Capture");

            [Fact]
            public void X262() => check("3K4/1P6/8/8/3Q4/k4b2/p1q5/8 w - - 5 141", "d4-d3",
                "Queen");

            [Fact]
            public void X263() => check("3K4/1P6/8/8/3Q4/k4b2/p1q5/8 w - - 5 141", "d4-c4", "Queen");

            [Fact]
            public void X264() => check(
                "2k5/rbp2r1p/np1p1q1n/p4p2/P3pQ1P/N5P1/1P1PP1B1/R1B1K1NR w - - 1 27",
                "f4-e4", "Queen, Capture");

            [Fact]
            public void X265() => check("k7/3n3Q/6p1/1P2P3/2pRN1Bp/p7/P1K2r2/R6N w - - 0 57", "e4-f2",
                "Knight, Capture");

            [Fact]
            public void X266() => check(
                "rn1q3r/2p1pk1p/3B1npb/1p1pQ3/1p1PP2P/2P3pP/P4P2/RN2KBR1 w Q - 6 15",
                "e5-f6", "Queen, Capture");

            [Fact]
            public void X267() => check(
                "rn1q3r/2p1pk1p/3B1npb/1p1pQ3/1p1PP2P/2P3pP/P4P2/RN2KBR1 w Q - 6 15",
                "e5-g3", "Queen, Capture");

            [Fact]
            public void X268() => check(
                "2k5/rb3r1p/1p1Q3n/p1pp1p2/P3p2P/1P1P1BPN/R1n1P3/2B2K1R w - - 1 38",
                "d6-c5", "Queen, Capture");

            [Fact]
            public void X269() => check("B4Q2/3r4/4kP2/ppp5/2P2K2/8/8/3q4 w - - 1 95", "f8-c5",
                "Queen, Capture");

            [Fact]
            public void X270() => check(
                "rnb2kn1/2pp4/pp2pp2/3q4/P2BPb2/2NP2Pp/1PPRNP1P/2K2B1R b - - 2 21",
                "f4-g5", "Bishop");

            [Fact]
            public void X271() => check(
                "rnb1kQn1/2pp4/pp1bpp2/q7/4P3/P1NPB1Pp/1PP1NP1P/2KR1B1R b q - 1 18",
                "d6-f8", "Bishop, Capture");

            [Fact]
            public void X272() => check("3Q1R2/8/k7/p7/P2P1p2/8/1N2B2K/5b2 b - - 2 88", "f1-e2",
                "Bishop, Capture");

            [Fact]
            public void X273() => check("8/5Rb1/p6n/P4k2/R6p/2p5/3p1K2/8 b - - 1 99", "h6-f7",
                "Knight, Capture");

            [Fact]
            public void X274() => check("2k2r2/7P/5Q2/1PQ5/p7/3n4/6K1/6N1 b - - 2 78", "d3-c5",
                "Knight, Capture");

            [Fact]
            public void X275() => check("4r3/5P2/6p1/4kR2/2pn3p/7K/8/6N1 b - - 3 86", "d4-f5",
                "Knight, Capture");

            [Fact]
            public void X276() => check("8/1P6/8/1N4P1/b4P2/P6N/1KR1n1k1/R5B1 b - - 2 56", "e2-f4",
                "Knight, Capture, MoveToCheck");

            [Fact]
            public void X277() => check("3k4/np2r3/1pNr1pP1/2P4p/3RP3/6Qb/p1K1NPB1/4B1R1 b - - 1 52",
                "a7-c6", "Knight, Capture");

            [Fact]
            public void X278() => check("1B6/3k1p2/pp4p1/nPpr2P1/4p2P/b2R3b/4P2R/3N2K1 b - - 3 41",
                "d5-d6", "Rook");

            [Fact]
            public void X279() => check("3k2n1/8/qp2R3/6p1/3r2BP/2P5/4P2P/2R3K1 b - - 6 57", "d4-e4",
                "Rook");

            [Fact]
            public void X280() => check(
                "2k5/rbQ1r2p/1p5n/p1pp1p2/P3p2P/1P1P1BPN/R1n1P3/2B2KR1 b - - 4 39",
                "e7-c7", "Rook, Capture");

            [Fact]
            public void X281() => check("2k5/6R1/8/7P/2R5/8/5NK1/2q5 b - - 5 123", "c1-c4",
                "Queen, Capture");

            [Fact]
            public void X282() => check(
                "3q1r2/rbpk3p/np1p3n/p3pp2/P4p1P/N2Q2P1/1P1PPKB1/R1B3NR b - - 3 23",
                "d8-e8", "Queen");

            [Fact]
            public void X283() => check("1r6/r1k2ppp/R1PqN2b/7n/3P1p1P/2R3P1/3N2K1/8 b - - 0 44",
                "d6-e6", "Queen, Capture");

            [Fact]
            public void X284() => check(
                "r1bqkbnr/pppB1p2/2n3p1/4p2p/8/5PP1/PPPPP2P/RNBQK1NR b KQkq - 0 5",
                "d8-d7", "Queen, Capture");

            [Fact]
            public void X285() => check("nr2r1n1/pb1p3k/1pp5/8/PbP1PpP1/1P1K2Pq/3R1P2/R3B3 b - - 1 36",
                "h3-g3", "Queen, Capture");

            [Fact]
            public void X286() => check("8/7n/5k1B/3P4/1K6/p7/5q2/8 b - - 8 121", "f2-g3", "Queen");

            [Fact]
            public void X288() => check(
                "1nb5/r2p1p2/3k1q2/1p2Q2B/p2pPP2/1Pb4P/P1P3P1/RNBK2NR b - - 0 20",
                "f6-e5", "Queen, Capture");

            [Fact]
            public void X289() => check("8/8/k2B3n/p2Pp1p1/2b3PP/1R2p3/RK5b/n7 b - - 3 70", "a1-b3",
                "Knight, Capture");

            [Fact]
            public void X290() => check("4R3/4k2B/8/8/7P/2p5/7K/8 b - - 26 93", "e7-e8",
                "King, Capture");

            [Fact]
            public void X291() => check("8/3R4/4kn2/1p6/4P1pP/2PB4/4R2P/7K b - - 5 68", "e6-d7",
                "King, Capture");
        }
    }
}
