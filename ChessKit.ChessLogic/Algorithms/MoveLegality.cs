        ...
        static MoveAnnotations ValidateWhiteCastlingMove(byte[] _cells, int fromSquare, int to, Castlings castlings)
        {
            ...
            switch (to)
            {
                case S.C1: // Queenside
                    ...
                    if (Attacks.IsSquareAttackedByBlack(_cells, S.E1)) return MoveAnnotations.King | MoveAnnotations.CastleFromCheck | MoveAnnotations.WQ;
                    if (Attacks.IsSquareAttackedByBlack(_cells, S.D1)) return MoveAnnotations.King | MoveAnnotations.CastleThroughCheck | MoveAnnotations.WQ;
                ...
                case S.G1: // Kingside
                    ...
                    if (Attacks.IsSquareAttackedByBlack(_cells, S.E1)) return MoveAnnotations.King | MoveAnnotations.CastleFromCheck | MoveAnnotations.WK;
                    if (Attacks.IsSquareAttackedByBlack(_cells, S.F1)) return MoveAnnotations.King | MoveAnnotations.CastleThroughCheck | MoveAnnotations.WK;
        ...
        static MoveAnnotations ValidateBlackCastlingMove(byte[] _cells, int fromSquare, int to, Castlings castlings)
        {
            ...
            switch (to)
            {
                case S.C8: // Queenside
                    ...
                    if (Attacks.IsSquareAttackedByWhite(_cells, S.E8)) return MoveAnnotations.King | MoveAnnotations.CastleFromCheck | MoveAnnotations.BQ;
                    if (Attacks.IsSquareAttackedByWhite(_cells, S.D8)) return MoveAnnotations.King | MoveAnnotations.CastleThroughCheck | MoveAnnotations.BQ;
                ...
                case S.G8: // Kingside
                    ...
                    if (Attacks.IsSquareAttackedByWhite(_cells, S.E8)) return MoveAnnotations.King | MoveAnnotations.CastleFromCheck | MoveAnnotations.BK;
                    if (Attacks.IsSquareAttackedByWhite(_cells, S.F8)) return MoveAnnotations.King | MoveAnnotations.CastleThroughCheck | MoveAnnotations.BK;
